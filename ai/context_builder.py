...
class ContextBuilder:
    ...
    def _build_voice_persona_constraints(self) -> str:
        return (
            ...
            "7. STRICT MODALITY ISOLATION: You are physically incapable of speaking and executing a tool call in the same response turn. If you need to ask the user a question to clarify a tool parameter, you MUST speak the question and yield the turn. Do not attempt to attach the tool call to your spoken response.\n"
    ...
    def _build_identity_switching_instructions(self) -> str:
        return (
            ...
            "1. If a caller introduces themselves mid-call (e.g., 'Hey, it's Alex'), you MUST immediately verify or swap profiles.\n"
            ...
            "4. The system will auto-create a new profile if they do not exist and hot-swap your memory layers in the background.\n"
            "</identity_resolution_protocol>"
        )
